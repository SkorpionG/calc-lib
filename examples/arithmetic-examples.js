...
console.log(`mod(17.5, 5.2) = ${mod(17.5, 5.2)}`); // 1.9 (with decimals)
...
console.log(`pow(2.5, 2) = ${pow(2.5, 2)}`); // 6.25 (exact value)
console.log(`pow(2.5, 2, 2) = ${pow(2.5, 2, 2)}`); // 6.3 (custom: 2 significant figures)
console.log(`pow(4, 0.5) = ${pow(4, 0.5)}`); // 2 (square root)
console.log(`sqrt(16) = ${sqrt(16)}`); // 4
console.log(`sqrt(2.0) = ${sqrt(2.0)}`); // 1.4142135623730951 (exact value)
console.log(`sqrt(2.0, 2) = ${sqrt(2.0, 2)}`); // 1.4 (custom: 2 significant figures)
console.log();
